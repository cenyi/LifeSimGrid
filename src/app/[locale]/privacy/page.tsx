...
const PAGE_DESCS: Record<string, string> = {
  ...
  fr: "Confidentialité : 100% client, aucune collecte, aucun suivi. Custom Designs, Mii. Sans inscription.",
  ko: "100% 클라이언트, 데이터 수집 없음, 추적 없음. 커스텀 디자인, Mii QR 무료. 계정 불필요.",
  de: "Datenschutz: 100% clientseitig, keine Erfassung, kein Tracking. ACNH, Mii. Keine Registrierung.",
